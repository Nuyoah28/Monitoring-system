...
class RuntimeConfig:
    ...
    AREA_ENTER_CONFIRM_SECONDS = _env_float("AREA_ENTER_CONFIRM_SECONDS", 0.5)
    AREA_ENTER_ALARM_ONCE = _env_bool("AREA_ENTER_ALARM_ONCE", True)
    ...
    ACTION_FALL_CONFIRM_FRAMES = _env_int("ACTION_FALL_CONFIRM_FRAMES", 50)
    ACTION_FALL_EXIT_FRAMES = _env_int("ACTION_FALL_EXIT_FRAMES", 15)
    ACTION_FALL_ALARM_ONCE = _env_bool("ACTION_FALL_ALARM_ONCE", True)
