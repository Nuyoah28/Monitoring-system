...
MAMBA_YOLO_CONFIG = Config.MAMBA_YOLO_CONFIG
MAMBA_YOLO_WEIGHTS = Config.MAMBA_YOLO_WEIGHTS
MAMBA_YOLO_CONFIDENCE = Config.MAMBA_YOLO_CONFIDENCE
MAMBA_YOLO_OPEN_CONFIG = Config.MAMBA_YOLO_OPEN_CONFIG
MAMBA_YOLO_OPEN_WEIGHTS = Config.MAMBA_YOLO_OPEN_WEIGHTS
MAMBA_YOLO_OPEN_CONFIDENCE = Config.MAMBA_YOLO_OPEN_CONFIDENCE
