...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Compare parking-space detection models on the same dataset."
    )
    parser.add_argument(
        "--config",
        type=str,
        default=str(root / "configs" / "compare_models.example.json"),
    ...
    parser.add_argument("--name", type=str, default="parking_model_compare", help="Output run name.")
